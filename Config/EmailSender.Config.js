  ...
  transport.sendMail(
    {
      ...
      html: `<h1>Email Confirmation</h1>
        ...
        <a href=${process.env.PROJECT_BACK_URL}ElhendawyRestaurant/activateAccount/${_id}/${confirmationCode}>verify your email</a>
        </div>`,
    },
    (error, info) => {
      if (error) {
  ...
  transport.sendMail(
    {
      ...
      html: `<h1>Email Confirmation</h1>
        ...
        <a href=${process.env.PROJECT_BACK_URL}ElhendawyRestaurant/resetPassword/?i=${_id}&c=${confirmationCode}>Reset Your Password</a>
        </div>`,
    },
    (error, info) => {
      if (error) {
